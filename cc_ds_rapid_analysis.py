...
def plot_daily_metric(df, start_date, end_date, title, filename, metric, std=False):
    df_subset = df[(df["created_at"] >= start_date) & (df["created_at"] <= end_date)]
    ...
    print(df_year_month_day.columns)
...
plot_daily_metric(
    ...
    "2019-03-05",
    "2019-03-25",
    "Std climate sentiment around 2019-03-15",
    "tweet_sentiment_03-15-std.png",
    "sentiment",
    std=True,
)
...
plot_daily_metric(
    ...
    "2019-03-25",
    "Mean aggressiveness around 2019-03-15",
    "tweet_aggressiveness_03-15-std.png",
    "aggressiveness",
    std=True,
)
...
plot_daily_metric(
    ...
    "2019-09-10",
    "2019-09-30",
    "Std climate sentiment around 2019-09-20",
    "tweet_sentiment_09-20-std.png",
    "sentiment",
    std=True,
)
...
plot_daily_metric(
    ...
    "2019-09-30",
    "Mean aggressiveness around 2019-09-20",
    "tweet_aggressiveness_09-20-std.png",
    "aggressiveness",
    std=True,
)
